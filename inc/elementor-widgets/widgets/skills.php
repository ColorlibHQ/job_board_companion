...
/**
 *
 * Job_Board elementor skills section widget.
 *
 * @since 1.0
 */
class Job_Board_Skills extends Widget_Base {

	public function get_name() {
		return 'job_board-skills';
	}

	public function get_title() {
		return __( 'My Skills', 'job_board-companion' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'skills_content',
			[
				'label' => __( 'Skills content', 'job_board-companion' ),
			]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'label_block' => true,
                'default'   => esc_html__( 'I’m a Creative director based on New York, who loves clean, simple & unique design. I also enjoy crafting', 'job_board-companion' ),
            ]
        );
        $this->add_control(
            'about_yourself',
            [
                'label' => esc_html__( 'About Yourself', 'job_board-companion' ),
                'type' => Controls_Manager::TEXTAREA,
                'label_block' => true,
        ...
        $this->add_control(
            ...
            [
                ...
                'label_block' => true,
                'default'   => esc_html__( 'Download CV', 'job_board-companion' ),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Personal Image Section', 'job_board-companion' ),
		...
		$this->add_control(
            'skills', [
                ...
                'fields' => [
                    [
                        'name' => 'item_title',
                        'label' => __( 'Skill Title', 'job_board-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::TEXT,
                        'default'     => __( 'Wireframing', 'job_board-companion' ),
                    ],
                    [
                        'name' => 'skill_val',
                        'label' => __( 'Skill Value', 'job_board-companion' ),
                        'label_block' => true,
                ...
                'default'   => [
                    [ 
                        'item_title'    => __( 'Weightlifting', 'job_board-companion' ),
                        'skill_val'   => __( '90', 'job_board-companion' ),
                    ],
                    [ 
                        'item_title'    => __( 'UI/UX', 'job_board-companion' ),
                        'skill_val'   => __( '70', 'job_board-companion' ),
                    ],
                    [ 
                        'item_title'    => __( 'Interaction design', 'job_board-companion' ),
                        'skill_val'   => __( '45', 'job_board-companion' ),
                    ],
                ]
            ]
		);
     ...
     */
        ...
        $this->start_controls_section(
            'style_features_section', [
                'label' => __( 'Style Features Section', 'job_board-companion' ),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'BG Styles', 'job_board-companion' ),
                'type' => Controls_Manager::HEADING,
                'separator' => 'after'
            ]
        );
        $this->add_control(
            'sec_bg_color', [
                'label' => __( 'Bg Color', 'job_board-companion' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
