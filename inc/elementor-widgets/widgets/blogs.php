...
/**
 *
 * Job_Board blogs Contents section widget.
 *
 * @since 1.0
 */
class Job_Board_Blogs extends Widget_Base {

	public function get_name() {
		return 'job_board-blogs';
	}

	public function get_title() {
		return __( 'Blogs', 'job_board-companion' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'blogs_content',
			[
				'label' => __( 'Blogs Contents', 'job_board-companion' ),
			]
        );
        $this->add_control(
            'big_text',
            [
                ...
                'label_block' => true,
                'default'   => esc_html__( 'Blog', 'job_board-companion' ),
            ]
        );
        $this->add_control(
            'sec_title',
            [
                'label' => esc_html__( 'Sec Title', 'job_board-companion' ),
                'type' => Controls_Manager::TEXT,
                'label_block' => true,
                'default'   => esc_html__( 'Our Creative Articles', 'job_board-companion' ),
            ]
        );
        $this->add_control(
            'btn_title',
            [
                'label'         => __( 'Button Title', 'job_board-companion' ),
                'type'          => Controls_Manager::TEXT,
                'label_block'   => true,
                'default'       => __( 'More Blogs', 'job_board-companion' )
            ]
        );
        $this->add_control(
            'btn_url',
            [
                'label'         => __( 'Button URL', 'job_board-companion' ),
        ...
        $this->add_control(
            'blogs_order',
            [
                'label'         => __( 'Blog Order', 'job_board-companion' ),
                'type'          => Controls_Manager::SWITCHER,
                'label_on' => __( 'DESC', 'job_board-companion' ),
				'label_off' => __( 'ASC', 'job_board-companion' ),
				'return_value' => 'yes',
				'default' => 'yes',
            ]
        );
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="creative_blog_active owl-carousel">
                        ...
                        <?php job_board_get_recent_blog_posts( $blogs_items, $blogs_order )?>
