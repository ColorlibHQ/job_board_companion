(function ($) {
    ...
    if ($.fn.owlCarousel) {
        $(".job_board-service-slides").owlCarousel({
            items: 3,
            loop: true,
            autoplay: true,
            smartSpeed: 800,
    ...
    if ($.fn.owlCarousel) {
        $(".job_board-workflow-slides").owlCarousel({
            items: 3,
            loop: true,
            autoplay: true,
            smartSpeed: 800,
    ...
    if ($.fn.owlCarousel) {
        $(".job_board-team-slides").owlCarousel({
            items: 3,
            loop: true,
            autoplay: true,
            smartSpeed: 800,
    ...
    if ($.fn.imagesLoaded) {
        $('.job_board-job_board').imagesLoaded(function () {
            // filter items on button click
            $('.job_board-menu').on('click', 'p', function () {
            ...
            // init Isotope
            var $grid = $('.job_board-job_board').isotope({
    ...
    $('.job_board-menu button.btn').on('click', function () {
        $('.job_board-menu button.btn').removeClass('active');
    ...
    // MC Scripts
    var $subscribe = $('.job_board-subscribe-newsletter-area');
    if ($subscribe.length) {
