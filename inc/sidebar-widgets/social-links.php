...
class Job_Board_social_links extends WP_Widget {
    ...
    function __construct() {
        ...
        'job_board_social_links',


        // Widget name will appear in UI
        esc_html__( '[ Job_Board ] Social Links', 'job_board-companion' ),

        // Widget description
        array( 'description' => esc_html__( 'Add footer social links.', 'job_board-companion' ), )
        );
    ...
    public function form( $instance ) {
        ...
        $title = isset( $instance[ 'title' ] ) ? $instance[ 'title' ] : esc_html__( 'Follow Us', 'job_board-companion' );
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'facebook' ) ); ?>"><?php esc_html_e( 'Facebook URL:' ,'job_board-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'twitter' ) ); ?>"><?php esc_html_e( 'Twitter URL:' ,'job_board-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'linkedin' ) ); ?>"><?php esc_html_e( 'Linkedin URL:' ,'job_board-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'instagram' ) ); ?>"><?php esc_html_e( 'Instagram URL:' ,'job_board-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'dribbble' ) ); ?>"><?php esc_html_e( 'Dribbble URL:' ,'job_board-companion'); ?></label>
...
} // Class job_board_social_links ends here


// Register and load the widget
function job_board_social_links_widget_load() {
	register_widget( 'Job_Board_social_links' );
}
add_action( 'widgets_init', 'job_board_social_links_widget_load' );